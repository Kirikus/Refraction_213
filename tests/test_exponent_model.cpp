...
BOOST_AUTO_TEST_SUITE(test_N_exp)

ExponentAtmosphericModel testModel;
...
BOOST_AUTO_TEST_CASE(N_10000m) {
  BOOST_TEST(testModel.N(10000 - 1e-6) == testModel.N(10000 + 1e-6),
             tt::tolerance(1e-6));
}
...
BOOST_AUTO_TEST_CASE(plot) {
  ...
  customPlot.addGraph();
  testModel = ExponentAtmosphericModel(0, 400);
  ...
  customPlot.addGraph();
  testModel = ExponentAtmosphericModel(0, 313);
  ...
  customPlot.addGraph();
  testModel = ExponentAtmosphericModel(0, 250);
